    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            <flux:sidebar.header>
                ...
                <livewire:notification-center class="hidden lg:block" />
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Financeiro')" class="grid">
                    <flux:sidebar.item icon="document-currency-dollar" :href="route('bills.index')" :current="request()->routeIs('bills.index')" wire:navigate>
                        {{ __('Despesas') }}
                    </flux:sidebar.item>
